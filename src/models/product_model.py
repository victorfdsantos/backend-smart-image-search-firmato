...
class ProductModel:
    ...
    prazo_entrega_dias_corridos: Optional[str] = None
    prazo_entrega_dias_uteis: Optional[str] = None
...
COLUMN_MAP: dict[str, str] = {
    ...
    "Prazo_Entrega_Dias_Corridos":      "prazo_entrega_dias_corridos",
    "Prazo_Entrega_Dias_Úteis":         "prazo_entrega_dias_uteis",
